...
public class Gates : MonoBehaviour
{
    ...
    [SerializeField] private ObstacleFrame _frameObstaclePf;
    ...
    public void Init(List<int[,]> gatePatterns, int distanceBtwObstacles)
    {
        ...
        SpawnObstacles(gatePatterns, distanceBtwObstacles);
    }
    ...
    private void SpawnObstacles(List<int[,]> gatePatterns, int distanceBtwObstacles)
    {
